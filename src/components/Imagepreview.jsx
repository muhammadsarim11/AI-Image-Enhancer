  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4'>
      <div className='w-60 bg-white shadow-md rounded-lg h-60 overflow-hidden '>
        ...
        {props.uploadimage ? (
          <img src={props.uploadimage} className='h-full w-full object-cover object-center ' alt="" />
        ) : (
      ...
      <div className='w-60 bg-white shadow-md rounded-lg h-60 overflow-hidden '>
        ...
        {props.loading ? (
          <div className='flex items-center justify-center h-full w-full'>
            <span className='text-blue-500 text-sm'>Enhancing...</span>
            {/* You can replace the text with a spinner if you have one */}
          </div>
        ) : props.enhancedimage ? (
